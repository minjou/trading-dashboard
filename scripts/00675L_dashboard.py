...
Usage:
  uv run --with finlab --with python-dotenv python3 WEB/00675L_dashboard.py
"""
...
<title>00675L v17 — K線 Dashboard</title>
<style>
...
import os
output_path = os.path.join(os.path.dirname(__file__), '00675L_v17_dashboard.html')
